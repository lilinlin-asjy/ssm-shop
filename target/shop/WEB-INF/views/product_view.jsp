                ...
                <div class="dt-if1-qietu">
                    ...
                    <div class="dt-qie-con f-l">
                     ...
                     <c:forEach begin="1" end="7" var="i">
                        	<li class="${i==1?'current':''}"><a href="#"><img src="${pageContext.request.contextPath}/${product.image}" style="width: 60px; height: 60px"/></a></li>
                        </c:forEach>
                        <div style="clear:both;"></div>
                        </ul>
                    </div>
        	...
        	<div class="dt-if1-m f-l">
                ...
                <dl class="dt-ifm-box3">
                    ...
                    <dd>
                        ...
                        <input type="number" value="1" name="count" id="count" min="1" max="10" required>
