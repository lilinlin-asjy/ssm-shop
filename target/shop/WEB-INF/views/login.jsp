...
<body>
	...
	<div class="sign-logo w1200">
        <h1 class="zl-h11"><a href="index.jsp" title="宅客微购"><img src="${pageContext.request.contextPath}/images/zl2-01.gif" /></a></h1>
    </div>
    ...
    <div class="sign-ipt f-l">
    	...
    	<p>用户名</p>
        <input type="text" placeholder="手机号/邮箱" name="username" id="username" value="${cookie.username.value}"/>
        <p>密码</p>
        <input type="password" placeholder="密码可见" name="password" id="pasword" value="${cookie.password.value}"/><br />
        <input type="checkbox" name="remember" ${empty cookie.username.value?"":"checked"} style="width:15px;height: 15px;margin-top:15px"> 记住密码7天<br/>
