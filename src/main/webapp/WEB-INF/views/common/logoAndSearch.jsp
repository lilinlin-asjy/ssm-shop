...
<div class="logo-search w1200">
    ...
    <div class="search f-r">
        <form action="${pageContext.request.contextPath}/product/products?cId=${productForPageBean.cId}&csId=${productForPageBean.csId}" method="post">
            <div class="search-info">
            <input type="text" placeholder="请输入商品名称" name="searchName" value="${productForPageBean.searchName}"/>
            <button>搜索</button>
            <div style="clear:both;"></div>
        </div>
        </form>
